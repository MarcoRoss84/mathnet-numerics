...
namespace MathNet.Numerics.Tests.LogicalTests
{
    ...
    public class VectorComparisonTestDouble
    {
        [Test]
        public void VectorLessThanVector()
        {
            var v1 = DenseVector.OfArray(new double[] { 13f, 15.6f, 0.8f, -3.1f, 5.2f });
            var v2 = DenseVector.OfArray(new double[] { 12f, 15.6f, 0.9f, -3.2f, 18.1f });
        ...
        {
            var v = DenseVector.OfArray(new double[] { 13f, 15.6f, 0.8f, -3.1f, 5.2f });
        ...
        {
            var v1 = DenseVector.OfArray(new double[] { 13f, 15.6f, 0.8f, -3.1f, 5.2f });
            var v2 = DenseVector.OfArray(new double[] { 12f, 15.6f, 0.9f, -3.2f });
